...
$sqlSelectKorisnik = "SELECT korisnik.korisnik_id, korisnik.korisnicko_ime, korisnik.email, uloga_korisnik.ime 
                      ...
                      WHERE korisnik.uloga_id = uloga_korisnik.uloga_id";
...
<head>
  <title>Upravljanje moderatorom</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device.width, initial-scale=1.0">
  <meta name="author" content="Ivan Jure Parać">
  <meta name="naslov" content="Dnevnik">
  <meta name="keywords" content="moderator, korisnici, prava">
    ...
    <tbody>
      ...
      ?>
          <tr>
            ...
            <td><a href="dodjeli_moderator.php?id=<?php echo $row['korisnik_id']; ?>"> Dodjeli ulogu moderator </a>
            </td>
          </tr>
      <?php }
      } ?>
