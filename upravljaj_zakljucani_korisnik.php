...
$sqlSelectKorisnik = "SELECT korisnik.korisnik_id, korisnik.korisnicko_ime, korisnik.email, uloga_korisnik.ime 
                      ...
                      WHERE korisnik.uloga_id = uloga_korisnik.uloga_id AND korisnik.uloga_id = 5";
...
<head>
  <title>Upravljanje zaključanim korisnicima</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device.width, initial-scale=1.0">
  <meta name="author" content="Ivan Jure Parać">
  <meta name="naslov" content="Upravljanje zaključanim korisnicima">
  <meta name="keywords" content="zaključani, korisnici, prava">
...
<header>
  <a href="#sadrzaj">
    <h1>Upravljanje zaključanim korisnicima</h1>
  </a>
    ...
    <tbody>
      ...
      ?>
          <tr>
            ...
            <td><a href="otkljucaj_korisnik.php?id=<?php echo $row['korisnik_id']; ?>"> Otključaj korisnika </a>
            </td>
          </tr>
      <?php }
      } ?>
