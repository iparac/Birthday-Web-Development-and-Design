...
$sqlSelect = "SELECT grupa.ime, rezervacija_termin.datum, rezervacija_termin.broj_djece, rezervacija_termin.rezervacija_id, rezervacija_termin.status_rezervacija_termina_id 
              FROM grupa, rezervacija_termin 
              WHERE grupa.grupa_id = rezervacija_termin.grupa_grupa_id AND rezervacija_termin.korisnik_id = '$korisnik_id'";
$sqlRezultatSelect = mysqli_query($conn, $sqlSelect);

 //Dnevnik otvoren pregled registracija
 ...
 $sqlSelectTipDnevnikId = "SELECT naziv FROM tip_dnevnik WHERE tip_dnevnik_id = 9";
 ...
 $sqlDnevnikInsert = "INSERT into dnevnik (korisnik_id, tip_dnevnik_id, radnja, datum_vrijeme)
        VALUES ('$korisnik_id', 9, '$nazivTip', NOW())";
...
<div class="sadrzaj1">
    ...
    <form action="rezervacija_termina.php" method="POST">
        <input type="submit" id="insert" class="submit" value="Unesi novu rezervaciju!" />
    </form><br><br>
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td><a href="rezervacija_update.php?id=<?php echo $row['rezervacija_id']; ?>"> Ažuriraj </a>&nbsp;
                            <a href="rezervacija_obrisi.php?id=<?php echo $row['rezervacija_id']; ?>">Obriši</a>
                        </td>
                    </tr>
            <?php }
            } ?>
