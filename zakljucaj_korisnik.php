...
if($sqlRezultatUpdateKorisnikUloga){
    //Dnevnik zakljucavanje korisnika
    ...
    $sqlSelectTipDnevnikId = "SELECT naziv FROM tip_dnevnik WHERE tip_dnevnik_id = 23";
    ...
    $sqlDnevnikInsert = "INSERT into dnevnik (korisnik_id, tip_dnevnik_id, radnja, datum_vrijeme)
       VALUES ('$korisnik_id', 23, '$nazivTip', NOW())";
    $sqlRezultatDnevnikInsert = mysqli_query($conn, $sqlDnevnikInsert);

    header("Location: upravljaj_otkljucani_korisnik.php");
